...
# @sparticuz/chromium bundles its own Chromium binary for serverless environments
# No need to install Chrome separately - the npm package handles it
echo "Using @sparticuz/chromium for Puppeteer (bundled Chromium)"
