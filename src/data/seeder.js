...
const seedDB = async () => {
  ...
  try {
    ...
    const feedbacks2024 = [
      ...
      { rating: 2, comment: 'Poor organization last year. Many sessions started late and the venue was inadequate.', userId: createdUsers[2]._id, eventId: techConference2024._id },
      { rating: 1, comment: 'Terrible experience in 2024. The speakers were boring and content was irrelevant.', userId: createdUsers[3]._id, eventId: techConference2024._id },
      { rating: 3, comment: 'Average conference. Nothing special, but not terrible either.', userId: createdUsers[4]._id, eventId: techConference2024._id },
      // Tagalog feedbacks for 2024
      { rating: 5, comment: 'Napakahusay ng konferensya noong nakaraang taon. Sana mas maganda ang audio quality.', userId: createdUsers[5]._id, eventId: techConference2024._id },
      { rating: 4, comment: 'Maganda ang mga presentasyon. Ang mga upuan ay medyo hindi komfortable.', userId: createdUsers[6]._id, eventId: techConference2024._id },
      { rating: 2, comment: 'Mahinang organisasyon noong 2024. Maraming sessions ang late at maliit ang venue.', userId: createdUsers[7]._id, eventId: techConference2024._id },
      { rating: 1, comment: 'Kakila-kilabot na karanasan noong 2024. Ang mga speakers ay nakakainip at ang nilalaman ay irrelevant.', userId: createdUsers[8]._id, eventId: techConference2024._id },
      { rating: 3, comment: 'Average lamang ang conference. Hindi espesyal pero hindi rin naman kakila-kilabot.', userId: createdUsers[9]._id, eventId: techConference2024._id },
    ];

    // 2023 Feedbacks (2 years ago - 8 feedbacks)
    const feedbacks2023 = [
      { rating: 3, comment: 'The 2023 conference was decent. More hands-on workshops would be better.', userId: createdUsers[0]._id, eventId: techConference2023._id },
      { rating: 4, comment: 'Good selection of speakers. The lunch break was too short.', userId: createdUsers[1]._id, eventId: techConference2023._id },
      { rating: 5, comment: 'Excellent technical content. Very well organized event.', userId: createdUsers[2]._id, eventId: techConference2023._id },
      { rating: 2, comment: 'Poor experience in 2023. The venue was terrible and staff was unhelpful.', userId: createdUsers[3]._id, eventId: techConference2023._id },
      { rating: 1, comment: 'Worst conference I attended that year. Complete waste of time and money.', userId: createdUsers[4]._id, eventId: techConference2023._id },
      { rating: 4, comment: 'Magandang nilalaman ang 2023 conference. Sana mas maraming praktikal na aktibidad.', userId: createdUsers[5]._id, eventId: techConference2023._id },
      { rating: 3, comment: 'Mabuti ang mga speakers pero kulang sa interactive sessions.', userId: createdUsers[6]._id, eventId: techConference2023._id },
      { rating: 2, comment: 'Mahinang karanasan noong 2023. Ang venue ay kakila-kilabot at ang staff ay hindi helpful.', userId: createdUsers[7]._id, eventId: techConference2023._id },
    ];

    // 2022 Feedbacks (3 years ago - 6 feedbacks)
    const feedbacks2022 = [
      { rating: 4, comment: 'The 2022 event was well-executed. Great learning experience overall.', userId: createdUsers[0]._id, eventId: techConference2022._id },
      { rating: 2, comment: 'Poor organization in 2022. The virtual platform was buggy and speakers were unprepared.', userId: createdUsers[1]._id, eventId: techConference2022._id },
      { rating: 1, comment: 'Terrible experience. The conference was a complete disaster with technical failures.', userId: createdUsers[2]._id, eventId: techConference2022._id },
      { rating: 4, comment: 'Good mix of theory and practice. The materials were helpful.', userId: createdUsers[3]._id, eventId: techConference2022._id },
      { rating: 3, comment: 'Average experience. The virtual platform had some issues.', userId: createdUsers[4]._id, eventId: techConference2022._id },
      { rating: 2, comment: 'Mahinang organisasyon noong 2022. Ang virtual platform ay buggy at ang mga speakers ay hindi handa.', userId: createdUsers[5]._id, eventId: techConference2022._id },
    ];
