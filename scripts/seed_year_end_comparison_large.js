...
// --- Comment Generators (from seed_large_dataset.js) ---
const ENGLISH_PARTS = {
  positive: {
...
const seed = async () => {
  try {
    await connectDB();
    console.log("Connected to MongoDB for large comparison seeding...");
    ...
    // --- 1. Create 2025 Event ---
    console.log("Creating Year End 2025...");
    ...
    // --- 2. Create 2026 Event ---
    console.log("Creating Year End 2026...");
    ...
    console.log("2. Find 'Year End 2026'.");
